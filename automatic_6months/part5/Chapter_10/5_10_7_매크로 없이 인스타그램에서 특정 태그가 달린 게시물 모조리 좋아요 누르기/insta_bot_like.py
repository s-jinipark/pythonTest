...
class LikeBot:
    ...
    def press_like(self, num):
        ...
        while count != 0:
            ...
            div = self.driver.find_element_by_xpath('/html/body/div[6]/div[3]/div/article/div/div[3]/div/div')
            like_btn = div.find_element_by_tag_name('button')
            like_btn.click()
            ...
            for el in svg:
                ...
                if el.get_attribute("aria-label") == "좋아요":
                    ...
                    break
            # //<-- 임시
            # test_xpath = '/html/body/div[6]/div[3]/div/article/div/div[3]/div/div/section[1]/span[1]/button/div[2]/span/svg/path'
            # # 최근 사진의 요소를 가져옵니다.
            # test_el = self.driver.find_element_by_xpath(test_xpath)
            # test_el.click()
            ...
            #svg = self.driver.find_elements_by_tag_name("svg")
            for el in svg:
                if el.get_attribute('aria-label') == "다음":
                    el.click()
                    break   # break 없으면 안됨(*)
