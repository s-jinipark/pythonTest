...
# 035420
#  정답확인
f = open("./291.txt", mode="wt", encoding="utf-8")
f.write("005930\n")
f.write("005380\n")
f.write("035420\n")
f.close()
...
# 035420 NAVER
#  정답확인
f292 = open("./292.txt", mode="wt", encoding="utf-8")
f292.write("005930 삼성전자\n")
f292.write("005380 현대차\n")
f292.write("035420 NAVER\n")
f292.close()
...
f293 = open("./293.csv", mode="wt", encoding="cp949", newline='')
writer = csv.writer(f293)
...
# 035420
#  정답확인
f294 = open("./291.txt", encoding="utf-8")
#lines = f294.readline() # readline() 아니고
lines = f294.readlines() #python list
#print(lines)
codes = []
for line in lines:
    code = line.strip()  # '\n'
...
# 035420 NAVER
#  정답확인
f295 = open("./292.txt", encoding="utf-8")
lines = f295.readlines()
#print(lines)
data = {}
for line in lines:
    line = line.strip() # '\n' 제거
