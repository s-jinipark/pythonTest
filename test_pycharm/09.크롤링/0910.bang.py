...
#https://apis.zigbang.com/v2/search?leaseYn=N&q=%EC%86%A1%ED%8C%8C%EA%B5%AC&serviceType=%EC%9B%90%EB%A3%B8
#leaseYn: N , q: 송파구 , serviceType: 원룸
leaseYn = "N"
q = "송파구"
serviceType = "원룸"
url = "https://apis.zigbang.com/v2/search?leaseYn={}&q={}&serviceType={}".format(leaseYn, q, serviceType)
...
_json = req.json()
#print(_json)
#print(_json.get("code"))
'''
{'success': True, 'code': '200', 
  'items': [{'id': 8209, 'type': 'address', 'name': '송파구', 'hint': '', 'description': '서울시 송파구', 'lat': 37.514591217041, 'lng': 127.105865478516, 'zoom': 7, 'polygon': [], '_score': None, 
    '_source': {'name_length': 3, 'local1': '서울시', 'local2': '송파구', 'local3': None, 'web_level': 14, 'web_lat': 37.514591217041, 'web_lng': 127.105865478516, 'app_level': 13, 'app_lat': 37.514591217041, 'app_lng': 127.105865478516, '법정동코드': '1171000000'}, 
    'zoom_level': {'google': 13, 'daum': 6}, 'zoom_level_v2': {'app': 8, 'web': 6}}], 
'next': None, 'limit': 0}
'''
